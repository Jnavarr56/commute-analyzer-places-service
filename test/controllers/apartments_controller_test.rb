...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { bathrooms: @apartment.bathrooms, bedrooms: @apartment.bedrooms, icon_color: @apartment.icon_color, name: @apartment.name, price: @apartment.price, state: @apartment.state, status: @apartment.status, street_address: @apartment.street_address, type: @apartment.type, user_id: @apartment.user_id, zip_code: @apartment.zip_code } }, as: :json
    end
